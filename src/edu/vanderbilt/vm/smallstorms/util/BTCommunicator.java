...
import edu.vanderbilt.vm.smallstorms.util.LCPMessage;
...
/**
 * This class is copied from MINDdroid <code>https://github.com/NXT/LEGO-MINDSTORMS-MINDdroid</code>
...
public BTCommunicator(BTConnectable myOwner, Handler uiHandler, BluetoothAdapter btAdapter) {
...
final Handler myHandler = new Handler() {
    ...
    public void handleMessage(Message myMessage) {
        ...
        if (myMessage.getData().getInt("message") != 0) {
            throw new IllegalStateException("Please use Message.what");
        }

        int message = myMessage.what;
        switch (message) {
        case MOTOR_A:
        case MOTOR_B:
        case MOTOR_C:
